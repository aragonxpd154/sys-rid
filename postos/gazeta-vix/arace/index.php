...
<ul>
    <li>
        <a href='\postos\'><em class="fa fa-home"></em> Voltar</a></li>
		<p></p>
		<li><a href='\postos\gazeta-vix\arace\manuais\'><em class="fa fa-book"></em>Manuais</a></li>
		<li><a href='\postos\gazeta-vix\arace\equipamentos\'><em class="fa fa-list"></em>Lista de Equipamento </a></li>
		<li><a href='\postos\gazeta-vix\arace\manutencao\'><em class="fa fa-wrench"></em>Manutenção</a></li>
		<li><a href='\postos\gazeta-vix\arace\relatorio\'><em class="fa fa-file"></em>Relatório</a></li>
...
<div class 'row grid-responsive'>
    <div class='column'>
        <div class='card'>
            ...
            <div class='badge float-right'>Chamado EDP: 64564</div>
            <div class='badge float-right'>Aracê, Domingos Martins - ES, 29260-000, Brasil</div>
            
                <!-- Titulo -->
                <h3>Posto de Aracê</h3>
                <p></p>
                <h5>Mapa</h5>

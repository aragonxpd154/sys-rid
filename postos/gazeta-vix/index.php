...
<ul>
    <li>
        ...
        <div id="rolagem">
        <p></p>
        <li><a href='\postos\gazeta-vix\'><em class="fa fa-file"></em>Fonte Grande</a></li>
		<li><a href='\postos\gazeta-vix\itanhenga\'><em class="fa fa-file"></em>Itanhenga</a></li>
		<li><a href='\postos\gazeta-vix\'><em class="fa fa-file"></em>Jaburuna</a></li>
		<li><a href='\postos\gazeta-vix\'><em class="fa fa-file"></em>Kautsky</a></li>
        <!--
        <li><a href='\postos\gazeta-vix\arace\manuais\'><em class="fa fa-file"></em>Fonte Grande</a></li>
        <li><a href='\postos\gazeta-vix\arace\listagem\'><em class="fa fa-file"></em>Itanhenga</a></li>
        <li><a href='\postos\gazeta-vix\'><em class="fa fa-file"></em>Jaburuna</a></li>
        <li><a href='\postos\gazeta-vix\'><em class="fa fa-file"></em>Kautsky</a></li>
        <li><a href='\postos\gazeta-vix\arace\manuais\'><em class="fa fa-file"></em>Fonte Grande</a></li>
        <li><a href='\postos\gazeta-vix\arace\listagem\'><em class="fa fa-file"></em>Itanhenga</a></li>
...
<div class 'row grid-responsive'>
    <div class='column'>
        <div class='card'>
			...
			<div class='badge float-right'>Sede Vitória , Rua: Chafic Murad, nº 902 - Monte Belo - ES, 29053-315, Brasil</div>
<!-- Titulo -->

<h3>Rede Gazeta Vitória</h3>
<p></p>
<h4>Selecione o posto conveniado no menu ao lado</h4>
<p></p>

<div>

<img width='440' height='600' frameborder='0,5' src='/imagens/vix.png' alt='Rede Gazeta Vitória' title=''/>

<img width="440" height="600" frameborder="0.5" src='/imagens/rede-vix.jpg'/>

</div>
</tbody>
</table>
			<p class="credit">Copyright - <a href="http://aragones.esy.es/rid-pro/">A Gazeta Rádio e Tv Ltd</a></p>
		</section>
	</div>

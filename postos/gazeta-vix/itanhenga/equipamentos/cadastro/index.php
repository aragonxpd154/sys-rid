...
<ul>
    <li>
        <a href='\postos\gazeta-vix\itanhenga\equipamentos\'><em class="fa fa-home"></em> Voltar</a></li>
</ul>
</div>
...
<form name='form' action='/postos/gazeta-vix/itanhenga/equipamentos/cadastro/' method='POST'>
<fieldset>
...
if(isset($_POST['env'])&& $_POST['env']=='Enviar'){
	...
	//echo $serie;
	//echo $patrimonio;
    $sql = "INSERT INTO gv_equipamentos (nome, sufixo, firmware, numeroSerie, patrimonio, posto, ativo) VALUES ";
    $sql .= "('$nome', '$sufixo', '$firmware', '$serie', '$patrimonio', '$posto', '$ativo')";
    //$sql.= "('$nome', '$sufixo', '$firmware', '$serie', '$patrimonio', '$posto', '$ativo')";

...
if($_GET['id']) {
	...
	$sql = "SELECT * FROM gv_tb_equipamentos_itanhenga WHERE id = {$id}";
...
<html lang="en">
    <head>
        ...
        <meta name='description' content='Pagina de remove equipamentos'>
        ...
        <title>| Itanhenga | Remover Equipamento </title>
...
<h3>Você realmente deseja remove o equipamento de Itanhenga?</h3>
<form action="acao/remove.php" method="post">

	<input type="hidden" name="id" value="<?php echo $data['id'] ?>" />
	<button type="submit">Sim</button>
	<a href="index.php"><button type="button">Não</button></a>
</form>

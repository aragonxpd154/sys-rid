...
if(@$_GET['id']) {
    ...
    $sql = "SELECT * FROM gv_equipamentos WHERE id = {$id}";
...
<html lang="en">
    <head>
        ...
        <meta name='description' content='Pagina de Edição de Equipamentos'>
        ...
        <title>| Itanhenga | Editar Equipamento? </title>
...
<fieldset>
    ...
    <form action="acao/update.php" method="post">
        <table cellspacing="0" cellpadding="0">
            ...
            <tr>
                <th>Sufixo</th>
                <td><input type="text" name="sufixo" placeholder="sufixo" value="<?php echo $data['sufixo'] ?>" /></td>
            </tr>
            <tr>
                <th>Versão de Firmware</th>
                <td><input type="text" name="firmware" placeholder="firmware" value="<?php echo $data['firmware'] ?>" /></td>
            </tr>
            <tr>
                <th>Numero de Serie</th>
                <td><input type="text" name="numeroSerie" placeholder="numeroSerie" value="<?php echo $data['numeroSerie'] ?>" /></td>
            </tr>

            <tr>
                <th>Numero de Patrimonio </th>
                <td><input type="text" name="patrimonio" placeholde='patrimonio' value="<?php echo $data['patrimonio'] ?>" /></td>
            </tr>
            <tr>
                <th>Posto</th>
                <td><input type="text" name="posto" placeholde='posto' value="<?php echo $data['posto'] ?>" /></td>
            </tr>
            <tr>
...
<scipt src='/js/chart.min.js'></script>

<?php require_once '/opt/lampp/htdocs/conexao/conexao.php'; ?>
<!-- Author: Marcos Silva\n
...
<ul>
    <li>
		...
		<p></p>
		<li><a href='\postos\gazeta-vix\itanhenga\equipamentos\cadastro\'><em class='fa fa-envelope'></em>Cadastrar um novo Equipamento</a></li>
...
<body>
		...
		<?php
			$sql = "SELECT * FROM gv_equipamentos WHERE ativo = 1 AND posto = 'itanhenga'";

...
<html lang="en">
    <head>
        ...
        <meta name='description' content='Pagina de Consulta equipamentos gsre'>
...
<ul>
    <li>
        <a href='/postos/gazeta-vix/gsre/'><em class="fa fa-home"></em> Voltar</a></li>
		<p></p>
		<li><a href='/postos/gazeta-vix/gsre/cadastro/'><em class="fa fa-edit"></em>Cadastrar Equipamento</a></li>
    ...
    <div class='column'>
        <div class='card'>
            <div class='card-title'>
                <!-- Titulo -->
                <h3>Lista de equipamento cadastrados no posto de gsre</h3>
</div>
